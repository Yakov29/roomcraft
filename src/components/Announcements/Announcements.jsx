...
const announcements = [
  {
    id: 7,
    title: "Тест-драйв редактора",
    description: "У редактор додано можливість тест-драйву 🎮",
    image: "/images/roomcraft-testdrive.jpg",
    color: "#e67e22",
    date: "2025-09-20T16:50:00",
  },
  {
    id: 6,
    title: "Реалістична меблі",
    description:
      "Оновлено систему відображення меблів — тепер вони ще реалістичніші",
  ...
  {
    id: 5,
    title: "Нові інструменти",
    description: "Додано масштабування кімнат та реалістичну підлогу",
  ...
  {
    id: 4,
    title: "Запуск RoomCraft",
    description: "Офіційний запуск RoomCraft на Vercel",
    ...
    <section className="announcements">
      <Container>
        <ul className="announcements__list">
          {announcements.map(
            ({ id, title, description, image, color, date }, index) => (
              <li
                key={id}
